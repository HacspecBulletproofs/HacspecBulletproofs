...
a multi-party computation (MPC) protocol where each party $\P_{(j)}$, takes on the
...
to be unwrapped. This resulted in \texttt{prove()} being somewhat
...
Finally the code we test against uses structs to keep hold of the values
