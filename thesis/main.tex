...
\begin{tabular}{ c|c|c } 
	...
	$n = 32, m = 2$   & 1,563.87 s   & 1.83  \\ \hline 
	$n = 64, m = 2$   & 2,073.97 s   & 3.56  \\ \hline 
	\hline\hline
	$n = 8, m = 4$    & 823.68 s     & 0.97  \\ \hline 
	$n = 16, m = 4$   & 1,585.96 s   & 1.79  \\ \hline 
	$n = 32, m = 4$   & 3,075.16 s   & 3.32  \\ \hline 
	$n = 64, m = 4$   & 6,107.19 s   & 6.55  \\ \hline 
	\hline\hline
	$n = 8, m = 8$    & 1,624.98 s   & 1.85  \\ \hline 
	$n = 16, m = 8$   & 3,127.60 s   & 3.49  \\ \hline 
	$n = 32, m = 8$   & 6,114.07 s   & 6.63  \\ \hline 
	$n = 64, m = 8$   & 10,418.94 s  & 12.69 \\ \hline 
	\hline\hline
	$n = 8, m = 16$   & 3,191.85 s   & 3.63  \\ \hline 
	$n = 16, m = 16$  & 6,209.07 s   & 7.20  \\ \hline 
	$n = 32, m = 16$  & 12,246.25 s  & 13.56 \\ \hline 
	$n = 64, m = 16$  & 24,303.13 s  & 26.06 \\ \hline 
	\hline\hline
	$n = 64, m = 32$  & 39,100.84 s  & 41.70 \\ \hline 
	\hline\hline
	$n = 64, m = 64$  & 67,508.52 s  & 64.59 \\ \hline 
\end{tabular}
\end{center}
