...
the commitment to $v$, $V$, made at the very start, is also a commitment
to $t_0$ as per the construction of $t_0$. Additionally $\P$ makes
commitments to $T_1 = C(t_1, \tt_1)$ and $T_2 = C(t_2, \tt_2)$. After
commiting these values to $\V$, $\V$ sends back a challenge scalar
$\ran{x}$. Now with the Pedersen-commitment having base-point $B$
and blinding point $\tB$ we know from the definitions of $V, T_1, T_2$
