...
The final part of the project was the implementation of the Bulletproofs protocol. The code was heavily based on the code we were testing against as well as the mathematical formulas explained in \ref*{Bulletproofs}. The implementation followed the pseudo-code format as seen above just like the implementation we test against did. The implementation ran into a few roadblocks during devealopment, some relating specifically to Hacspec. 
