...
And some abbreviations for Result types:
...
to generalize over the \texttt{Scalar} type. This turned out to
...
\begin{algorithm}[H]
	...
	\SetKwFunction{createDealer}{create\_dealer()}
	\SetKwFunction{createParty}{create\_Party()}
	$dealer\_awaiting\_bit\_commitments := \createDealer$ \\
	\For{$j \in [0: \vec{v}.len()]$}{
		$party\_j\_awaiting\_bit\_challenge := \createParty$
	}
