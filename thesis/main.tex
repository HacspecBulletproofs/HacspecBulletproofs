...
Revisited" paper \cite{edwards-curves} which was used as a guide
for our implementation. This specification was very helpful, as it
clearly defined the types and functionalities needed to implement
Ristretto securely.
...
have optimizations which make the code faster than if they simply
...
Hacspec Ristretto specification, but for each operation it simply calls
