...
fn unit_test() {
    ...
    let r1: Scalar =
        Scalar::from_hex("0000000000000000000000000000000000000000000000000000f34000000000");
    let r2: Scalar =
        Scalar::from_hex("0000000000000000000000000000000000000000000000000100000000000000");
    let r3: Scalar = r1 + r2;

    let a1: Scalar =
        Scalar::from_hex("0000000000000000000000000000000000000000000000000b00000000000000");
    let a2: Scalar =
        Scalar::from_hex("0000000000000000000000000000000000000000000000658a00000000000001");
    let a3: Scalar = a1 + a2;
